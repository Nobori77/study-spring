...
public class JwtAuthenticationFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        if(memberEmail != null && socialMemberProvider != null && SecurityContextHolder.getContext().getAuthentication() == null){
            ...
            MemberDTO foundMember = memberDAO.findMemberByMemberEmail(memberDTO).orElseThrow(() -> {throw new MemberException("doFilterInternal 회원 조회 실패", HttpStatus.BAD_REQUEST);});
